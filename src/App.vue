...
@media(max-width:1180px){.content>header{align-items:stretch;flex-direction:column;gap:14px;margin-bottom:22px}.header-copy{min-width:0}.header-actions{flex-flow:row wrap!important;align-items:stretch!important;justify-content:flex-start}.monitor-launch{min-width:240px;flex:1 1 260px}.health-launch,.sync{flex:0 0 auto}}
@media(max-width:1050px){.health-launch small{display:none}.health-launch{padding-inline:14px}.header-actions{gap:8px}.monitor-launch{order:4;flex-basis:100%}.sync{margin-left:auto}}
</style>
